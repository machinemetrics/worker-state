...
RedisWorkerStore.prototype.commit = function () {
  ...
  self.log('commit', 'Write = ' + self.pendingWrite.length + ', Delete = ' + self.pendingDelete.length +
    ', KeyAdd = ' + self.pendingKeyAdd.length + ',' + subAdd + ', KeyDel = ' + self.pendingDelete.length + ',' + subDel);
