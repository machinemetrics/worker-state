...
function KinesisWorkerState (app, stream, shard, workerStore, kinesis) {
  WorkerState.call(this, app, shard, workerStore);
  this.stream = stream;
...
KinesisWorkerState.prototype.getParentShards = function () {
  ...
  return async.whilst(function () {
    ...
    return self.kinesis.describeStream(params).promise().then(function (data) {
